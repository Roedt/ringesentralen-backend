...
USER quarkus
WORKDIR /build
RUN native-image $(cat native-image.args) -J-Xmx26g --initialize-at-run-time=org.apache.http.impl.auth.NTLMEngineImpl --initialize-at-run-time=com.google.protobuf.UnsafeUtil --trace-class-initialization=com.google.protobuf.UnsafeUtil
