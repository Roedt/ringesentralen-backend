...
enum class OpptattAv(val displaytext: String) {
    ...
    Brukestatensressurserpaaaaskapemiljoevennligearbeidsplasser("Bruke statens ressurser på å skape miljøvennlige  arbeidsplasser"),
    ...
    Norskkontrolloverkraftpolitikken("Norsk kontroll over kraftpolitikken"),
    ...
    Atasylsoekereskalfaajobbemensdeventerpaasvar("At asylsøkere skal få jobbe mens de venter på  svar"),
    Stanseletingogutbyggingavnyeoljefelt("Stanse leting og utbygging av nye oljefelt"),
    Neitilnyevindkraftanleggpaaland("Nei til nye vindkraftanlegg på land"),
    Kutteiegenandelenpaahelsetjenester("Kutte i egenandelen på helsetjenester"),
    Styrkedetnorskeforsvaret("Styrke det norske forsvaret"),
    Taimotflereasylsoekereogkvoteflyktninger("Ta imot flere asylsøkere og kvoteflyktninger"),
    Sikreatingenmisterdagpengeneutentilbudomjobbellerutdanning("Sikre at ingen mister dagpengene uten tilbud om  jobb eller utdanning"),
    Enikkekommersiellboligsektormedbilligereboliger("En ikke-kommersiell boligsektor med billigere boliger"),
