...
data class Membership(
    ...
    // Ser kanskje ut som timestamp-format? "2020-10-26T11:24:36.479475+01:00
    @JsonProperty(
        "start_date"
    ) val startDate: String,
    // Bør vera LocalDate, men orkar ikkje starte med custom-deserialisering utan at det er naudsynt
