...
CREATE TABLE IF NOT EXISTS `kommune` (
  ...
  INDEX(`fylke_id`)
    ...
    INSERT INTO kommune(navn,nummer,fylke_id,lokallag_id) VALUES ('Jevnaker',532,5, (select id from lokallag where navn = 'Rødt Ringerike'));
    ...
    INSERT INTO kommune(navn,nummer,fylke_id,lokallag_id) VALUES ('Hurum',628,6, (select id from lokallag where navn = 'Rødt Asker'));
    ...
    INSERT INTO kommune(navn,nummer,fylke_id,lokallag_id) VALUES ('Røyken',627,6, (select id from lokallag where navn = 'Rødt Asker'));
    ...
    INSERT INTO kommune(navn,nummer,fylke_id,lokallag_id) VALUES ('Svelvik',711,7, (select id from lokallag where navn = 'Rødt Drammen'));
    ...
    INSERT INTO kommune(navn,nummer,fylke_id,lokallag_id) VALUES ('Iveland',935,9, (select id from lokallag where navn = 'Rødt Vennesla'));
    ...
    INSERT INTO kommune(navn,nummer,fylke_id,lokallag_id) VALUES ('Åseral',1026,10, (select id from lokallag where navn = 'Rødt Setesdal'));
    ...
    INSERT INTO kommune(navn,nummer,fylke_id,lokallag_id) VALUES ('Halsa',1571,15, (select id from lokallag where navn = 'Uten lag Trøndelag'));
    ...
    INSERT INTO kommune(navn,nummer,fylke_id,lokallag_id) VALUES ('Tjeldsund',1852,18, (select id from lokallag where navn = 'Uten lag Troms'));
    ...
    INSERT INTO kommune(navn,nummer,fylke_id,lokallag_id) VALUES ('Svalbard',2100,21, (select id from lokallag where navn = 'Uten lag Troms'));
    INSERT INTO kommune(navn,nummer,fylke_id,lokallag_id) VALUES ('Jan Mayen',2211,21, (select id from lokallag where navn = 'Uten lag Troms'));
...
INSERT INTO `postnummerIKommunerMedFleireLag` (postnummerFra, postnummerTil, lokallag) VALUES
(1200, 1299, (select id from lokallag where navn = 'Rødt Oslo Søndre Nordstrand')),
(1187, 1189, (select id from lokallag where navn = 'Rødt Oslo Østensjø')),
(1150 ,1185 , (select id from lokallag where navn = 'Rødt Oslo Nordstrand')),
(0970 ,0976 , (select id from lokallag where navn = 'Rødt Oslo Grorud')),
(0951 ,0964 , (select id from lokallag where navn = 'Rødt Oslo Grorud')),
(0950 ,0950 , (select id from lokallag where navn = 'Rødt Oslo Bjerke')),
(0851 ,0884 , (select id from lokallag where navn = 'Rødt Oslo Nordre Aker')),
(0850 ,0850 , (select id from lokallag where navn = 'Rødt Oslo St. Hanshaugen')),
(0750 ,0791 , (select id from lokallag where navn = 'Rødt Oslo Vest')),
(0678 ,0694 , (select id from lokallag where navn = 'Rødt Oslo Østensjø')),
(0677 ,0677 , (select id from lokallag where navn = 'Rødt Oslo Nordstrand')),
(0672 ,0676 , (select id from lokallag where navn = 'Rødt Oslo Alna')),
(0671 ,0671 , (select id from lokallag where navn = 'Rødt Oslo Østensjø')),
(0668 ,0670 , (select id from lokallag where navn = 'Rødt Oslo Alna')),
(0667 ,0667 , (select id from lokallag where navn = 'Rødt Oslo Østensjø')),
(0664 ,0666 , (select id from lokallag where navn = 'Rødt Oslo Alna')),
(0650 ,0663 , (select id from lokallag where navn = 'Rødt Oslo Gamle Oslo')),
(0589 ,0598 , (select id from lokallag where navn = 'Rødt Oslo Bjerke')),
(0587 ,0588 , (select id from lokallag where navn = 'Rødt Oslo Nordre Aker')),
(0586 ,0586 , (select id from lokallag where navn = 'Rødt Oslo Bjerke')),
(0585 ,0585 , (select id from lokallag where navn = 'Rødt Oslo Grünerløkka')),
(0580 ,0584 , (select id from lokallag where navn = 'Rødt Oslo Bjerke')),
(0579 ,0579 , (select id from lokallag where navn = 'Rødt Oslo Grünerløkka')),
(0577 ,0578 , (select id from lokallag where navn = 'Rødt Oslo Gamle Oslo')),
(0562 ,0576 , (select id from lokallag where navn = 'Rødt Oslo Grünerløkka')),
(0561 ,0561 , (select id from lokallag where navn = 'Rødt Oslo Gamle Oslo')),
(0556 ,0560 , (select id from lokallag where navn = 'Rødt Oslo Grünerløkka')),
(0555 ,0555 , (select id from lokallag where navn = 'Rødt Oslo Sagene')),
(0550 ,0554 , (select id from lokallag where navn = 'Rødt Oslo Grünerløkka')),
(0486 ,0495 , (select id from lokallag where navn = 'Rødt Oslo Nordre Aker')),
(0485 ,0845 , (select id from lokallag where navn = 'Rødt Oslo Sagene')),
(0484 ,0848 , (select id from lokallag where navn = 'Rødt Oslo Nordre Aker')),
(0457 ,0483 , (select id from lokallag where navn = 'Rødt Oslo Sagene')),
(0450 ,0456 , (select id from lokallag where navn = 'Rødt Oslo St. Hanshaugen')),
(0445 ,0445 , (select id from lokallag where navn = 'Rødt Oslo Sagene')),
(0373 ,0383 , (select id from lokallag where navn = 'Rødt Oslo Vest')),
(0372 ,0372 , (select id from lokallag where navn = 'Rødt Oslo Nordre Aker')),
(0362 ,0371 , (select id from lokallag where navn = 'Rødt Oslo Vest')),
(0358 ,0361 , (select id from lokallag where navn = 'Rødt Oslo St. Hanshaugen')),
(0350 ,0357 , (select id from lokallag where navn = 'Rødt Oslo Vest')),
(0349 ,0349 , (select id from lokallag where navn = 'Rødt Oslo Nordre Aker')),
(0340 ,0340 , (select id from lokallag where navn = 'Rødt Oslo St. Hanshaugen')),
(0252 ,0287 , (select id from lokallag where navn = 'Rødt Oslo Vest')),
(0251 ,0251 , (select id from lokallag where navn = 'Rødt Oslo St. Hanshaugen')),
(0250 ,0250 , (select id from lokallag where navn = 'Rødt Oslo Vest')),
(0198 ,0198 , (select id from lokallag where navn = 'Rødt Oslo Nordstrand')),
(0194 ,0196 , (select id from lokallag where navn = 'Rødt Oslo Gamle Oslo')),
(0193 ,0193 , (select id from lokallag where navn = 'Rødt Oslo Nordstrand')),
(0187 ,0192 , (select id from lokallag where navn = 'Rødt Oslo Gamle Oslo')),
(0175 ,0175 , (select id from lokallag where navn = 'Rødt Oslo Grünerløkka')),
(0186 ,0186 , (select id from lokallag where navn = 'Rødt Oslo Grünerløkka')),
(0183 ,0185 , (select id from lokallag where navn = 'Rødt Oslo St. Hanshaugen')),
(0182 ,0182 , (select id from lokallag where navn = 'Rødt Oslo Grünerløkka')),
(0151 ,0166 , (select id from lokallag where navn = 'Rødt Oslo St. Hanshaugen')),
(0176 ,0181 , (select id from lokallag where navn = 'Rødt Oslo St. Hanshaugen')),
(0168 ,0174 , (select id from lokallag where navn = 'Rødt Oslo St. Hanshaugen')),
(0167 ,0167 , (select id from lokallag where navn = 'Rødt Oslo Vest')),
(0150 ,0150 , (select id from lokallag where navn = 'Rødt Oslo Gamle Oslo')),
(0915 ,0915 , (select id from lokallag where navn = 'Rødt Oslo Stovner')),
(0968 ,0969 , (select id from lokallag where navn = 'Rødt Oslo Stovner')),
(0977 ,0988 , (select id from lokallag where navn = 'Rødt Oslo Stovner')),
(1000 ,1004 , (select id from lokallag where navn = 'Rødt Oslo Alna')),
(1005 ,1005 , (select id from lokallag where navn = 'Rødt Oslo Stovner')),
(1006 ,1054 , (select id from lokallag where navn = 'Rødt Oslo Alna')),
(1055 ,1055 , (select id from lokallag where navn = 'Rødt Oslo Stovner')),
(1056 ,1083 , (select id from lokallag where navn = 'Rødt Oslo Alna')),
(1084 ,1089 , (select id from lokallag where navn = 'Rødt Oslo Stovner')),
(5004	,5004	, (select id from lokallag where navn = 'Rødt Bergen Sentrum')),
(5011	,5022	, (select id from lokallag where navn = 'Rødt Bergen Sentrum')),
(5033	,5033	, (select id from lokallag where navn = 'Rødt Bergen Nord')),
(5036	,5043	, (select id from lokallag where navn = 'Rødt Bergen Nord')),
(5052	,5053	, (select id from lokallag where navn = 'Rødt Bergen Vest')),
(5059	,5059	, (select id from lokallag where navn = 'Rødt Bergen Vest')),
(5063	,5067	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(5073	,5075	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(5081	,5089	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(5094	,5096	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(5141	,5144	, (select id from lokallag where navn = 'Rødt Bergen Vest')),
(5145	,5145	, (select id from lokallag where navn = 'Rødt Bergen Sentrum')),
(5146	,5161	, (select id from lokallag where navn = 'Rødt Bergen Vest')),
(5163	,5173	, (select id from lokallag where navn = 'Rødt Bergen Vest')),
(5176	,5184	, (select id from lokallag where navn = 'Rødt Bergen Vest')),
(5221	,5235	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(5238	,5253	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(5260	,5269	, (select id from lokallag where navn = 'Rødt Bergen Nord')),
(5009	,5009	, (select id from lokallag where navn = 'Rødt Bergen Vest')),
(5055	,5055	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(5072	,5072	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(5093	,5093	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(5097	,5097	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(5236	,5236	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(5222	,5224	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(5081	,5081	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(5232	,5232	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(5073	,5073	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(5097	,5097	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(5160	,5165	, (select id from lokallag where navn = 'Rødt Bergen Vest')),
(5032	,5032	, (select id from lokallag where navn = 'Rødt Bergen Nord')),
(5034	,5035	, (select id from lokallag where navn = 'Rødt Bergen Nord')),
(5010	,5010	, (select id from lokallag where navn = 'Rødt Bergen Sentrum')),
(5056	,5056	, (select id from lokallag where navn = 'Rødt Bergen Vest')),
(5037	,5037	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(5057	,5057	, (select id from lokallag where navn = 'Rødt Bergen Vest')),
(5258	,5258	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(5006	,5008	, (select id from lokallag where navn = 'Rødt Bergen Møhlenpris')),
(5010	,5010	, (select id from lokallag where navn = 'Rødt Bergen Møhlenpris')),
(5005	,5005	, (select id from lokallag where navn = 'Rødt Bergen Sentrum')),
(5237	,5237	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(5058	,5058	, (select id from lokallag where navn = 'Rødt Bergen Vest')),
(5100	,5136	, (select id from lokallag where navn = 'Rødt Bergen Nord')),
(5099	,5099	, (select id from lokallag where navn = 'Rødt Bergen Sør')),
(7069,7069,(select id from lokallag where navn ='Trondheim Strinda')),
(7046,7059,(select id from lokallag where navn ='Trondheim Strinda')),
(7070,7093,(select id from lokallag where navn ='Trondheim-Sentrum')),
(7097,7099,(select id from lokallag where navn ='Trondheim-Sentrum')),
(7400,7499,(select id from lokallag where navn ='Trondheim-Sentrum')),
(7014,7014,(select id from lokallag where navn ='Trondheim Østbyen')),
(7000,7013,(select id from lokallag where navn ='Trondheim-Sentrum')),
(7040,7045,(select id from lokallag where navn ='Trondheim Østbyen')),
...
('Donald', ' Duck',	'+4712345678',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 209),
('Hetti', ' Duck',	'+4712345677',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 209),
('Letti', ' Duck',	'+4712345679',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 1),
('Netti', ' Duck',	'+4712345676',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 1),
('Klodrik', ' Duck',	'+4712345675', 1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 1),
('Anton', ' Duck',	'+4712345674',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 1),
('Bestemor', ' Duck',	'+4712345673',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 1),
('Skrue', 'McDuck',	'+4712345672',	3050,	NULL,	6,	1,	'2020-08-22 23:29:09', 1),
('Gulbrand', 'Gråstein',	'+4712345671',	3050,	NULL,	6,	1,	'2020-08-22 23:29:09', 1),
('Spøkelseskladden', '',	'+4712345670',	3050,	NULL,	6,	1,	'2020-08-22 23:29:09', 1);

INSERT INTO `person` (`fornavn`, `etternavn`, `telefonnummer`, `postnummer`, `email`, `fylke`, `groupID`, `oppretta`, `lokallag`) VALUES
('Aster', 'ix',	'+4722345678',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 1),
('Obel', 'ix',	'+4722345677',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 1),
('Idef', 'ix',	'+4722345679',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 1),
('Majest', 'ix',	'+4722345676',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 1),
('Miracul', 'ix',	'+4722345675',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 1),
('Hermet', 'ix',	'+4722345665',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 1),
('Trubadur', 'ix',	'+4722346676',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 1),
('Barometr', 'ix',	'+4722346677',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 1),
('Gode', 'mine',	'+4722346678',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 1),
('Senil', 'ix',	'+4722346679',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 1),
('Armam', 'ix',	'+4722345680',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 1),
('Lillef', 'ix',	'+4722345681',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 1),
('Remoul', 'adine',	'+4722345682',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 1),
('Tragicom', 'ix',	'+4722345683',	1,	NULL,	-1,	1,	'2020-08-22 23:29:09', 1);
